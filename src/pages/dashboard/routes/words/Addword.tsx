...
import axiosInstance from "../../../../services/api/index.tsx";

import { useTheme } from "../../../../contexts/ThemeContext.tsx";
// import useAddWord from '../api/useAddWord.tsx';
...
const AjouterWord = () => {
  ...
  return (
    ...
    <AjouterWordContent
      ...
      errorCategories={errorCategories ? errorCategories.toString() : null}
...
type Props = {
  ...
  dataCategories: Array<{ id: number; name: string }> | null;
  handleSubmit: (event: React.FormEvent<HTMLFormElement>) => void;
};
const AjouterWordContent = ({
  wordData,
  handleChange,
  success,
  error,
  ...
  return (
    <>
      ...
      >
        {/* <NavBar /> */}
        <div className="flex-grow flex items-center justify-center py-12 pt-0 px-4 sm:px-6 lg:px-8">
          <div
